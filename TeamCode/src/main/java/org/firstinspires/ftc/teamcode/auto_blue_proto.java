...
@Autonomous
public class auto_blue_proto extends OpMode {
    ...
    public void buildPaths(double power_adj) {
        ...
        intake2ToScore = follower.pathBuilder()
                .addPath(new BezierCurve(gateOpenEnd, goBack2CP, score))
                .setLinearHeadingInterpolation(gateOpenEnd.getHeading(), score.getHeading(), 0.99)
                .addParametricCallback(0.99, () -> Intake.setPower(0))
                .build();
